                                    ...
                                    <tbody class="divide-y divide-gray-100 font-semibold text-gray-800 bg-white">
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition">
                                            ...
                                            <td class="py-4 px-8 text-right space-x-2 flex justify-end">
                                                <button type="button" data-url="{{ route('admin.data-master.update', $addon->id) }}" data-name="{{ $addon->name }}" onclick="openEditModal(this)" class="text-gray-400 hover:text-brand-blue transition w-8 h-8 rounded-md hover:bg-gray-100 inline-flex items-center justify-center"><i class="fa-regular fa-pen-to-square"></i></button>
    ...
    <div id="editModal" class="fixed inset-0 z-50 hidden bg-gray-900/50 flex items-center justify-center backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform transition-all">
            <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                <h3 class="text-lg font-bold text-gray-900">Edit Add On</h3>
