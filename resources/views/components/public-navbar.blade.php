    ...
    <nav class="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="{{ route('public.catalog') }}" class="px-4 py-2 rounded-lg font-semibold transition {{ Request::routeIs('public.catalog*') ? 'text-brand-600 bg-brand-50' : 'text-gray-600 hover:text-brand-600 hover:bg-gray-50' }}">Katalog</a>
        ...
        <div class="hidden md:hidden bg-white border-b border-gray-100 px-4 py-2 shadow-lg" id="mobile-menu">
            ...
            <a href="{{ route('public.catalog') }}" class="block px-4 py-3 rounded-lg font-semibold transition {{ Request::routeIs('public.catalog*') ? 'text-brand-600 bg-brand-50' : 'text-gray-600 hover:text-brand-600 hover:bg-gray-50' }}">Katalog</a>
